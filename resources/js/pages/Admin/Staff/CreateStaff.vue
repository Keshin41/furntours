...
const form = useForm({
    ...
    role: '',
    email: '',
    role_level: props.availableRoleLevels[0] as 'user' | 'moderator' | 'admin' | 'master',
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="h-32 w-32 overflow-hidden rounded-full border-4 border-light-blue/30">
                                    ...
                                    <div
                                        v-else
                                        class="h-full w-full bg-gradient-to-br from-[#2c3e50] to-[#34495e] flex items-center justify-center text-4xl text-light-blue"
                                    >
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-3">
                                <div v-for="level in props.availableRoleLevels" :key="level" class="flex items-center gap-3">
                                    ...
                                    />
                                    <Label :for="level" class="cursor-pointer text-white mb-0 capitalize">{{ level }}</Label>
                                </div>
                            </div>
