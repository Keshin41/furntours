...
<template>
    <div>
        ...
        <div
            v-if="errorMessage"
            class="fixed top-20 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/20 px-6 py-4 text-red-400 shadow-lg animate-in fade-in slide-in-from-top-5"
        >
